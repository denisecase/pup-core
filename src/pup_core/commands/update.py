...
from pup_core.sync.plan import (
    build_update_plan,
    filter_update_plan,
    write_update_plan,
)
from pup_core.templates.fetch import TemplateSource
from pup_core.write.terminal import (
    print_update_diffs,
    print_update_plan,
)
...
def run(
    *,
    ...
    Args:
        root: Repository root. If None, pup-core detects the current repo root.
